...
import { cn } from "@sheet-hub/ui/lib/utils";
    ...
    <div className="flex">
      <div
        ...
        className={cn(
          ...
          open && "w-60 min-w-60 max-w-60",
          "flex flex-1 flex-col h-screen p-3 bg-accent shadow duration-300 overflow-hidden",
        )}
      >
          ...
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            <li className="rounded-sm">
              ...
              >
                ...
                <span className=" group-data-[open=false]:hidden">Home</span>
              </Link>
            </li>
            <li className="rounded-sm">
              <Link
